...
export function ErrorRouter(props:any) {
	const koshisms:string[]=["We take no interest in the affairs of others.",
	...
	return (
		<div style={{width:"100%",textAlign:"center",backgroundColor:"#EDE8D3",padding:"30px 20px",marginTop:"10px"}}>
			...
			<p style={{marginBottom:"10px"}}>Sorry, a router error seems to have occurred.</p>
